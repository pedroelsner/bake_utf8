<?php
/**
 * Arquivo que executa o comando 'bake_utf8 model'
 *
 ...
 * @use         BakeUtf8Task
 * @package     bake_utf8
 * @subpackage  bake_utf8.model_task
 * @link        http://www.github.com/pedroelsner/bake_utf8
 */
class ModelTask extends BakeUtf8Task
{
 ...
 * All
 *
 * Responde ao comando 'bake_utf8 model all'
 *
 * @access public
 */
    function all() {
 ...
 * Help
 *
 * Responde o comando 'bake_utf8 model help'
 *
 * @access public
 */
    function help() {
        $this->hr();
        $this->out("Usage: cake bake_utf8 model <arg1>");
        $this->hr();
        $this->out('Arguments:');
        $this->out();
        $this->out("<name>");
