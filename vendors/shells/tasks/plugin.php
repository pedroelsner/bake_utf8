<?php
/**
 * Arquivo que executa o comando 'bake_utf8 plugin'
 *
 ...
 * @use         Shell
 * @package     bake_utf8
 * @subpackage  bake_utf8.plugin_task
 ...
 * Help
 *
 * Responde o comando 'bake_utf8 plugin help'
 *
 * @access public
 */
    function help() {
        $this->hr();
        $this->out("Usage: cake bake_utf8 plugin <arg1> <arg2>...");
        $this->hr();
        $this->out('Commands:');
        $this->out();
