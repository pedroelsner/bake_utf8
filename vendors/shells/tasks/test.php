<?php
/**
 * Arquivo que executa o comando 'bake_utf8 test'
 *
 ...
 * @use         BakeUtf8Task
 * @package     bake_utf8
 * @subpackage  bake_utf8.test_task
 * @link        http://www.github.com/pedroelsner/bake_utf8
 */
class TestTask extends BakeUtf8Task
{
 ...
 * Help
 *
 * Responde o comando 'bake_utf8 test help'
 *
 * @access public
 */
    function help() {
        $this->hr();
        $this->out("Usage: cake bake_utf8 test <type> <class>");
        $this->hr();
        $this->out('Commands:');
        $this->out("");
