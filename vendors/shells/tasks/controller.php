<?php
/**
 * Arquivo que executa o comando 'bake_utf8 controller'
 *
 ...
 * @use         BakeUtf8Task
 * @package     bake_utf8
 * @subpackage  bake_utf8.controller_task
 * @link        http://www.github.com/pedroelsner/bake_utf8
 */
class ControllerTask extends BakeUtf8Task
{
 ...
 * All
 *
 * Responde ao comando 'bake_utf8 controller all'
 *
 * @access public
 */
    function all()
 ...
 * Help
 *
 * Responde o comando 'bake_utf8 controller help'
 *
 * @access public
 */
    function help() {
        $this->hr();
        $this->out("Usage: cake bake_utf8 controller <arg1> <arg2>...");
        $this->hr();
        $this->out('Arguments:');
        $this->out();
        $this->out("<name>");
