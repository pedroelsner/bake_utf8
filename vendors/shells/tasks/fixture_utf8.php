<?php
/**
 * Arquivo que executa o comando 'bake_utf8 fixture_utf8'
 *
 ...
 * @use         BakeUtf8Task
 * @package    	bake_utf8
 * @subpackage 	bake_utf8.fixture_utf8_task
 * @link        http://www.github.com/pedroelsner/bake_utf8
 */
class FixtureUtf8Task extends BakeUtf8Task
{
	 ...
	 * All
	 *
	 * Responde ao comando 'bake_utf8 fixture_utf8 all'
	 *
	 * @access public
	 */
	function all()
	{
		$this->interactive = false;
		$this->ModelUtf8->interactive = false;
		$tables = $this->ModelUtf8->listAll($this->connection, false);
	...
	{
		$this->DbConfig->interactive = $this->ModelUtf8->interactive = $this->interactive = true;
		$this->hr();
		...
		$modelName = $this->ModelUtf8->getName($this->connection);
		$useTable = $this->ModelUtf8->getTable($modelName, $this->connection);
	 ...
	 * Help
	 *
	 * Responde o comando 'bake_utf8 fixture_utf8 help'
	 *
	 * @access public
	 */
	function help() {
